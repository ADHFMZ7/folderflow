...
import { TrafficLights } from "../../prototype/shell";
...
/**
 * The page list. Its top row leaves room for the window's traffic lights and can
 * be dragged to move the window. Collapsed, it's a rail of icons.
 */
